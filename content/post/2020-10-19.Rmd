---
title: Determining the effect of the Income Bracket of a Canadian Citizen by Naturalization
  on that Individual's Probability of Having Recieved a Bachelor's Degree
author: "Ilke Sun"
...
From the results we have, we conclude that we have statistically significant results for 4 out of 6 categories of income: the lowest (Less than $25,000), fourth ($75,000 to $99,999), second highest ($100,000 to $ 124,999) and the highest ($125,000 and more) income brackets. For the lowest income bracket we have log probability of -0.44087 which suggest that p-hat equals to approximately 39%. This suggest that if a Canadian Citizen by naturalization earns less than $25,000, there is 39% chance that individual has a Bachelor's degree and 61% chance that he does not. For the fourth income category, we can say that the log probability is 0.68057 and the actual probability of that indivudal having a Bachelor's degree is approximately 66%. For the fifth and the second highest income category, if an individual earns between $100,000 to $ 124,999 we expect the log probability to be 0.92316 and the actual probability of having a Bachelor's degre to be approximitely 72%. Lastly, if a Canadian by naturalization earns more than $125,000, we expect that individual's log probability of having a Bachelor's degree to be 1.28785 and the actual probability to be approximitely 78%. We see that when we compare the lowest and highest income brackets, the probability of an individual having a Bachelor's degree approximitely doubles. This does not entail that someone who recieves a Bachelor's degree is more likely to be in higher brackets but it means that if a person belongs to the highest income bracket it is almost two times more likely that person has a Bachelor's degree.
